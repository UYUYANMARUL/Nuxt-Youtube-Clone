...
export class Mig11701109433801 implements MigrationInterface {
    name = 'Mig11701109433801'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "follower_table" ("userId" uuid NOT NULL, "followingId" uuid NOT NULL, CONSTRAINT "PK_c8a3d179497e4af60a638ccf390" PRIMARY KEY ("userId", "followingId"))`);
        ...
        await queryRunner.query(`ALTER TABLE "follower_table" ADD CONSTRAINT "FK_d9eda6c074538143bb2d9c7365d" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "follower_table" ADD CONSTRAINT "FK_bb2f006ff617023565935400e1b" FOREIGN KEY ("followingId") REFERENCES "user"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "follower_table" DROP CONSTRAINT "FK_bb2f006ff617023565935400e1b"`);
        await queryRunner.query(`ALTER TABLE "follower_table" DROP CONSTRAINT "FK_d9eda6c074538143bb2d9c7365d"`);
        ...
        await queryRunner.query(`DROP TABLE "follower_table"`);
