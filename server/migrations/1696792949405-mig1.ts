...
export class Mig11696792949405 implements MigrationInterface {
    name = 'Mig11696792949405'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "like_table" ("likeCondition" integer NOT NULL, "user_id" uuid NOT NULL, "video_id" uuid NOT NULL, "videoId" uuid, "userId" uuid, CONSTRAINT "PK_d2771fec01ba7b0337219d7e737" PRIMARY KEY ("user_id", "video_id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "user" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "userName" text NOT NULL, "thirdname" text NOT NULL, "name" text, "email" text NOT NULL, "emailVerified" date, "image" bytea, "backgroungImage" bytea, "description" text, CONSTRAINT "UQ_da5934070b5f2726ebfd3122c80" UNIQUE ("userName"), CONSTRAINT "UQ_497f8a7dc1dcf252089a50e920d" UNIQUE ("thirdname"), CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "playlist" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdDate" TIMESTAMP NOT NULL DEFAULT now(), "updatedDate" TIMESTAMP NOT NULL DEFAULT now(), "titles" text, "description" text, "userId" uuid, CONSTRAINT "PK_538c2893e2024fabc7ae65ad142" PRIMARY KEY ("id"))`);
