...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"/home/marul/Nuxt/Nuxt-Youtube-Clone/.data/kv"}));
...
const _lazy_MXIRkB = () => import('../_...trpc_.mjs');
const _lazy_FW7ZZL = () => import('../openapi.json.mjs');
const _lazy_3kneGa = () => import('../test.mjs');
const _lazy_YNxuc3 = () => import('../_trpc_.mjs');
const _lazy_BWMhEl = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/api/**:trpc', handler: _lazy_MXIRkB, lazy: true, middleware: false, method: undefined },
  { route: '/api/openapi.json', handler: _lazy_FW7ZZL, lazy: true, middleware: false, method: undefined },
  { route: '/api/test', handler: _lazy_3kneGa, lazy: true, middleware: false, method: undefined },
  { route: '/api/trpc/:trpc', handler: _lazy_YNxuc3, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_BWMhEl, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_BWMhEl, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, hash as A, defu as B, parseQuery as C, withTrailingSlash as D, withoutTrailingSlash as E, FetchError as F, vercel as G, defineEventHandler as a, send as b, createError$1 as c, dr as d, eventHandler as e, getResponseStatus as f, getRequestURL as g, setResponseStatus as h, isMethod as i, setResponseHeaders as j, joinURL as k, useRuntimeConfig as l, getQuery as m, getRouteRules as n, getResponseStatusText as o, withQuery as p, hasProtocol as q, readBody as r, setResponseHeader as s, parseURL as t, useNitroApp as u, isScriptProtocol as v, wn as w, sanitizeStatusCode as x, createHooks as y, getRequestHeaders as z };
