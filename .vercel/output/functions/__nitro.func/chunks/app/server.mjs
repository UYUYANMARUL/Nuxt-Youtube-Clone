import { version, unref, inject, hasInjectionContext, getCurrentInstance, useSSRContext, createApp, reactive, provide, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, toRef, shallowRef, shallowReactive, isReadonly, defineAsyncComponent, isRef, isShallow, isReactive, toRaw, mergeProps, nextTick, onScopeDispose, ref, defineComponent, h, Suspense, Transition } from 'vue';
import { l as useRuntimeConfig$1, p as withQuery, q as hasProtocol, t as parseURL, v as isScriptProtocol, k as joinURL, c as createError$1, $ as $fetch, x as sanitizeStatusCode, y as createHooks, z as getRequestHeaders, F as FetchError, A as hash, B as defu } from '../nitro/vercel.mjs';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-1b35db8b.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-d07dfe0d.mjs').then((m) => m.default || m)
  }
];
...
const client_A25i47TKRZ = /* @__PURE__ */ defineNuxtPlugin(async (nuxtApp) => {
  ...
  async function test() {
    const data = await client.video.getVideoById.useQuery({
      id: "8d51397a-5a7d-4d46-94be-ee5f0339edea"
    });
    console.log("h");
    console.log(data);
  }
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-404-85718a92.mjs').then((r) => r.default || r));
    const _Error = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-500-8fbbc874.mjs').then((r) => r.default || r));
...
const _sfc_main = {
  ...
  __ssrInlineRender: true,
  setup(__props) {
    const IslandRenderer = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/island-renderer-9bd56a21.mjs').then((r) => r.default || r));
    const nuxtApp = /* @__PURE__ */ useNuxtApp();
